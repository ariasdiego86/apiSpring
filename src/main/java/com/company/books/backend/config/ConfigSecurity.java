    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        http.authorizeHttpRequests(configure -> {
            configure  // TODO Tiene que estar escritos igual en la base de datos (es case-sensetive),en la base puede anteponerse ROLE_ antes de lo escrito aquí
                    ...
                    .requestMatchers(HttpMethod.GET, "/libros/{id}/imagen").hasRole("BOSS")
                    .requestMatchers(HttpMethod.GET, "/v1/autores").hasAnyRole("EMPLOYEE", "BOSS", "SCHOLAR")
                    .requestMatchers(HttpMethod.GET, "/v1/autores/**").hasAnyRole("EMPLOYEE", "BOSS")
