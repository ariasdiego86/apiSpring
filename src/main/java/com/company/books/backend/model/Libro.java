...
public class Libro implements Serializable {
    ...
    * */
    ...
    @Lob
    private byte [] imagenBytes;// Este es el campo que se almacenará en la base de datos

    @JsonIgnore
    @Transient // Esto evita que Hibernate intente persistir este campo (ampo no persistido en la base de datos)
    private MultipartFile imagen;

    @Transient
    private String imagenBase64; // Campo no persistido en la base de datos
